...
class ModeSpecificConfig:
    ...
    def _load_mode10_config(self, mode_defaults):
        self.m10_output_suffix = mode_defaults.get('output_filename_suffix', '_recording')
        self.m10_num_matches = mode_defaults.get('num_matches', 5)
        self.m10_start_match = mode_defaults.get('start_match', 0)
        self.m10_video_fps = mode_defaults.get('video_fps', 60)
        self.m10_video_width = mode_defaults.get('video_resolution_width', 1920)
        self.m10_video_height = mode_defaults.get('video_resolution_height', 1080)
    ...
    def __init__(self, mode_number=None, app_config=None):
        ...
        mode_loaders = {
            ...
            41: self._load_mode41_config,
            10: self._load_mode10_config, # 新增
        }
